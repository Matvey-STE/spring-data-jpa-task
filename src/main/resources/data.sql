...
INSERT INTO users (birth_date, firstname, lastname, role, username, password, company_id)
VALUES ('1990-01-10', 'Ivan', 'Ivanov', 'ADMIN', 'ivan@gmail.com', '123',
        (SELECT id FROM company WHERE name = 'Google')),
       ('1995-10-19', 'Petr', 'Petrov', 'USER', 'petr@gmail.com', '123',
        (SELECT id FROM company WHERE name = 'Google')),
